...
| [0029](0029-what-redaction-does-and-what-it-refuses-to-do.md) | What redaction does, what it refuses to do, and what "verified" is allowed to mean | **Proposed** — written from [spike 0006](../spikes/0006-what-survives-a-redaction.md); extends [0022](0022-every-operation-verifies-its-own-output.md) with the content predicate |
